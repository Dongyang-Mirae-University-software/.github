...
위급 상황: 실시간 영상 AI가 낙상·화재·흉기를 감지하면 자동 신고 및 보호자·관리자에게 즉시 알림
평소 상황: AI 의료 챗봇으로 증상 상담 → 진료과 추천 → 병원 예약까지 원스톱 연결
...
- 중간발표 PPT: [발표자료](docs/실버브릿지_중간발표.pptx)
- 최종발표 PPT: [발표자료](docs/실버브릿지_최종발표.pptx)
